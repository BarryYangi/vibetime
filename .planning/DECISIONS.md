...
## 1. Phase 1 active decisions (proposed)
...
| D-PRECOMMIT | Pre-commit hooks (lefthook / simple-git-hooks) | Recommended SKIP for Phase 1; revisit if `pnpm run ci` velocity becomes painful | Open Question 3: nothing in PRD requires it; minimal scaffolding wins (RESEARCH.md Open Questions §3). | 1 | proposed |
